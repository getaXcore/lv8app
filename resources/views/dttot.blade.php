...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
			...
			<form method="post" action="<?php echo url('/dttot')?>" class="form-control">
				...
				<div class="mb-3 row">
					...
					<div class="col-sm-auto">
						<input type="text" class="form-control" name="nik" value="<?php if(isset($_POST['submit'])){echo $_POST["nik"];} ?>">
					</div>
				</div>
				<div class="mb-3 row">
					<label class="col-sm-2 col-form-label">Nama</label>
					<div class="col-sm-auto">
						<input type="text" class="form-control" name="nama" value="<?php if(isset($_POST['submit'])){echo $_POST["nama"];} ?>">
					</div>
				</div>
				<div class="mb-3 row">
					<label class="col-sm-2 col-form-label">Tempat Lahir</label>
					<div class="col-sm-auto">
						<input type="text" class="form-control" name="tempat_lahir" value="<?php if(isset($_POST['submit'])){echo $_POST["tempat_lahir"];} ?>">
					</div>
				</div>
				<div class="mb-3 row">
					<label class="col-sm-2 col-form-label">Tanggal Lahir</label>
					<div class="col-sm-auto">
						<input type="date" class="form-control" name="tanggal_lahir" value="<?php if(isset($_POST['submit'])){echo $_POST["tanggal_lahir"];} ?>">
					</div>
				</div>
				<div class="mb-3 row">
					<label class="col-sm-2 col-form-label">Alamat</label>
					<div class="col-sm-auto">
						<textarea class="form-control" name="alamat" ><?php if(isset($_POST['submit'])){echo $_POST["alamat"];} ?></textarea>
					</div>
				</div>
				<div class="mb-3 row">
	...
	if(isset($_POST['submit'])){
		...
		<div class="container-sm" style="margin-top: 1%;">
			&nbsp;<button type="button" class="btn btn-primary btn-lg" id="cetak" name="cetak" onclick="printa();">Cetak Data</button>
			<?php
			$post = $_POST;
			?>
			&nbsp;<a class="btn btn-primary btn-lg" href="<?php echo url('cetak/1');?>" role="button" target="_blank">Tes Cetak Data</a>
		</div>
